"""
Django settings for newnewsapp project.
...
AUTH_USER_MODEL='testapp.signup'
...
MIDDLEWARE = [
    ...
    #'testapp.middleware.errormsgmiddleware',
]

ROOT_URLCONF = 'newnewsapp.urls'
...
WSGI_APPLICATION = 'newnewsapp.wsgi.application'
